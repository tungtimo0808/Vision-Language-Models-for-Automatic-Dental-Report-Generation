"""Train Qwen2.5-VL-7B on the PAN924 dental dataset (RTX 3090, QLoRA 4-bit).

Run it from anywhere:
    python vlm_report_dataset/training/rtx3090/train_qwen.py
...
USE_MAX_PIXELS = True      # Qwen uses dynamic resolution
ATTN_IMPL = None           # flash-attn works fine for Qwen
...
# 2) pick the best checkpoint, evaluate on the test set, save results/qwen_results.txt
